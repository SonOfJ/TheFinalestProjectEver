...
### DAY 11 - May 30, 2019
**Christy**
- In class, I worked on creating a start screen. I am displaying an image for the start scree and the user presses the space key to start the game. At home, I created a game over screen that shows up when PacMan has lost all three lives. I also started adding comments to the code to explain what it does.
